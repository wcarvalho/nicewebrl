...
class LearningAlgorithm:
  ...
  def __call__(self, rng):
    pass
    ####################
    # Step 1: compute learning update
    ####################
    ...
    ####################
    # compute these
    # example: https://github.com/wcarvalho/jaxneurorl/blob/b72ce4ee89cf27048f006abb8f072dd24a1aad56/jaxneurorl/agents/qlearning.py#L105
    statistics = None

    ####################
    # Step 3: log what's happening in 1 episode/batch of data
    ####################
    # example: https://github.com/wcarvalho/preplay-AI/blob/bd3505aa1be39d98fe0e512e9c1df29b47c9a435/qlearning_housemaze.py#L143
...
def make_train(config):
    ...
    basic_env = nx.make('MiniGrid-Empty-8x8-v0')
    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            def _learn_phase(train_state, rng):
                ...
                learning_algorithm(rng, train_state, buffer_state)
...
def main():
    ...
    rngs = jax.random.split(rng, config["NUM_SEEDS"])  # [NUM_SEEDS, 2]
    train_fn = make_train(config)
    train_v = jax.vmap(train_fn, in_axes=0, out_axes=0)
