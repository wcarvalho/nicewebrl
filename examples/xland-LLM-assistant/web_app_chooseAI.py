...
async def index(request: Request):
  ...
  if "selected_model" not in app.storage.user:
    with ui.dialog() as dialog, ui.card():
      ...
      ui.label("Select which AI you'd like to help you through the game:").classes(
        "mb-4"
      )
      ...
      with ui.row().classes("w-full justify-center gap-4"):
        for model in model_list:
          with (
            ui.card()
            .classes("w-48 cursor-pointer hover:bg-gray-100")
      ...
      ui.label("Click on your preferred AI to begin").classes(
